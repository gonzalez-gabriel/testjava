...
public class ControladorPrincipal  {
    public static void main(String[] args) {
        ...
        Producto unProducto1 = new Producto("Producto1",1, "Producto1",1.0f, Estado.DISPONIBLE, Categoria.ENTRADA);        
        Producto unProducto2 = new Producto("Producto2",2, "Producto2", 2.0f, Estado.DISPONIBLE, Categoria.PLATO_PRINCIPAL);
        Producto unProducto3 = new Producto("Producto3",3, "Producto3",3.0f, Estado.DISPONIBLE, Categoria.POSTRE);
